...
def main():
    ...
    # ======================================= CREATE FLIGHT INFORMATION DATA =======================================
    df = pd.DataFrame()
    ...
    df["flightDate"] = ["2022-05-20", "2022-05-19", "2022-05-18", "2022-05-17"]
    df["ticket_price"] = [567, 678, 890, 123]
    df["delay"] = [True, False, True, False]
    df.to_csv("mock_data/mock_flight_delay_data_1.csv", index=False)
    ...
    df_2["flightDate"] = ["2022-05-20", "2022-05-19", "2022-05-18", "2022-05-17"]
    df_2["ticket_price"] = [567, 678, 890, 123]
    df_2["delay"] = [True, False, True, False]
    df_2.to_csv("mock_data/mock_flight_delay_data_2.csv", index=False)
    ...
    df_3["flightDate"] = ["2022-05-16", "2022-05-19", "2022-05-18", "2022-05-17"]
    df_3["ticket_price"] = [567, 678, 890, 123]
    df_3["delay"] = [True, False, True, False]
    df_3.to_csv("mock_data/mock_flight_delay_data_3.csv", index=False)
